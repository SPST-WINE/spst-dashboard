...
.base(process.env.AIRTABLE_BASE_ID_SPST!);
...
listByEmail(process.env.AIRTABLE_TABLE_SPEDIZIONI!, email),
listByEmail(process.env.AIRTABLE_TABLE_SPEDIZIONI_RIV!, email),
]);
