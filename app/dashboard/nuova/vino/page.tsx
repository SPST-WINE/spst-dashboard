...
// ------------------------------------------------------------
// Places proxy calls (no CORS/referrer problemi)
// ------------------------------------------------------------
...
function newSessionToken() {
  // token “random” per sessione di autocomplete
...
export default function NuovaVinoPage() {
  ...
  // ------------------------------------------------------------
  // Autocomplete: menu custom collegato agli input esistenti
  // ------------------------------------------------------------
...
dd.style.cssText = [
  ...
  'display:none',
      ...
      const onBlur = (e: FocusEvent) => {
        // chiudi dopo breve per permettere click sui li
        setTimeout(() => {
  ...
  // Aggancia agli input con data-gmaps impostato da PartyCard
  useEffect(() => {
    ...
    // se la UI rimonterà (Reactive), osserva cambi nel DOM per riagganciare
